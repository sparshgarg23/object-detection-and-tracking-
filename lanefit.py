...
#STEPS
#Construct a histogram for the bottom image where the lanes start
#from the bottom corners,use sliding wndow to move upwards and add 
#those pixels whose intensity is more than the maximum pixel
#intensities in the histogram
#Then perform polynomial fitting to get smooth curves
#Finally calculate radius of curve
#Note radius of curve is defined as [(1+(dx/dy)^2)^3/2]/(|d^2x/d^2y|)
#Also note all caluclations are in image domain.Perform dimensional
#conversions
